...
$home = isset($_SESSION['user_id']) ? ($_SESSION['role']==='admin' ? '/Margaux_Collections/admin/dashboard.php' : '/Margaux_Collections/customer/products.php') : '/Margaux_Collections/auth/login.php';
?>
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>404 — Margaux Collections</title>
...
<body><div class="wrap">
  <img src="/Margaux_Collections/images/logo.jpg" class="logo" alt="Logo" onerror="this.style.display='none'">
